...
export const GET  = async() => {
    try{
        ...
        return new NextResponse(JSON.stringify(users, null, 2), {status:200});
    }catch(error: any){
...
export const POST = async(request: Request) =>{
    try{
        ...
        return new NextResponse(JSON.stringify( {message:"User has been created", user: newUser}), {status:200});
    }catch(error: any){
...
export const PATCH = async(request:Request)=>{
    try{
        ...
        return new NextResponse(JSON.stringify({message:"User has been updated", user:updatedUser}), {status:200});
    }catch(error: any){
...
export const DELETE = async(request:Request) =>{
    try{
        ...
        return new NextResponse(JSON.stringify({message: "User has been deleted", user: deletedUser}), {status:200});
    }catch(err:any){
